...
validate_lab_result <- function(lab_data, result_value, result_unit, loinc_code, patient_id, lab_datetime){
  ...
  cat(paste0(red, Warning, " ", blue, low_unreportable_records, reset, " extremely low result records were flagged (low_unreportable).\n"))
  ...
  cat(paste0(red, Warning, " ", blue, logic_flag_records, reset, " result records were flagged for violating relational logic rules (logic_flag).\n"))
  ...
  cat(paste0(red, Warning, " ", blue, delta_flag_records1, reset, " records were flagged for having extreme change values from previous results within 7 days (delta_flag_7d).\n"))
  ...
  cat(paste0(red, Warning, " ", blue, delta_flag_records2, reset, " records were flagged for having extreme change values from previous results within 8-90 days (delta_flag_8_90d).\n"))
  ...
  cat(paste0(green, success," ",blue, plausibility_check, "%", reset, " of the lab data records were validated with no flag detected.\n"))
